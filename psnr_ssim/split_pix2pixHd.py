...
def split_by_name(dir_path, real_save_path, fake_save_path):
    ...
    for file in os.listdir(dir_path):
        ...
        elif 'synthesized_' in file:
            copy(tmp_file, fake_save_path + os.sep + file)

if __name__ == '__main__':
    dir_path = './Pix2PixHD/results/sar2opt/test_latest/images'
    real_path = './Pix2PixHD/results/sar2opt/test_latest/real'
    fake_path = './Pix2PixHD/results/sar2opt/test_latest/fake'
    print("Split Pix2pixHD...")
